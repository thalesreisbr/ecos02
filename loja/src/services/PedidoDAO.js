...
const { pedidos: entity,imagens:imagens,exposicao:exposicao, produtos_fisicos:produtos_fisicos, produtos_digitais:produtos_digitais,status:statusModel, exposicao_produtos_fisicos:exposicao_produtos_fisicos } = IniciarModels(database);
