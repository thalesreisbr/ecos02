...
class AutoWriter {
    ...
    createAssociations(typeScript) {
        ...
        fkTables.forEach(t => {
            const [schemaName, tableName] = types_1.qNameSplit(t);
            const modelName = types_1.recase(this.options.caseModel, tableName, this.options.singularize);
            ...
            fkFieldNames.forEach(fkFieldName => {
                ...
                if (spec.isForeignKey) {
                    const targetModel = types_1.recase(this.options.caseModel, spec.foreignSources.target_table, this.options.singularize);
